...
@Model(adaptables = {SlingHttpServletRequest.class, Resource.class}, defaultInjectionStrategy = DefaultInjectionStrategy.OPTIONAL, resourceType = FooterModel.RESOURCE_TYPE)
@Exporter(name = ExporterConstants.SLING_MODEL_EXPORTER_NAME, extensions = ExporterConstants.SLING_MODEL_EXTENSION)
public class FooterModel {
    protected static final String RESOURCE_TYPE = "training/components/new_footer";
    ...
    @PostConstruct
    protected void init(){
        log.debug("init method called for footer");
